...
// const API_BASE = import.meta.env.VITE_API_BASE || "http://localhost:3000/auth";
...
//   const hasSubscription = ["Active"].includes(profile.subscriptionStatus);
//   const hasActiveSubscription = profile.subscriptionStatus === "Active";
//   const hasSelectedCharity =
//     !!profile.selectedCharityId && Number(profile.contributionPercentage || 0) >= 10;
//   const canParticipate = hasSubscription && hasSelectedCharity;
...
//       setSuccess("Subscription selected successfully.");
...
//     if (!canParticipate) {
//       setError("You need subscription and charity selection before adding scores.");
//       return;
//     }
...
//               className="w-full rounded-full bg-emerald-600 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-700 transition disabled:opacity-60"
//             >
...
//             After successful selection, charity and scores unlock on this page.[web:150]
//           </p>
...
//             className="mt-4 w-full rounded-full bg-emerald-600 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-700 transition disabled:opacity-60 disabled:cursor-not-allowed"
//           >
...
//               <span
//                 className={`font-semibold ${hasActiveSubscription ? "text-emerald-700" : "text-amber-700"
//                   }`}
//               >
...
//               className="mt-4 w-full rounded-full bg-blue-600 px-5 py-3 text-sm font-semibold text-white hover:bg-blue-700 transition disabled:opacity-60 disabled:cursor-not-allowed"
//             >
...
//               Complete subscription and charity selection to add scores.
//             </p>
//           )}
...
//               disabled={!canParticipate}
//               className="rounded-full bg-emerald-600 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-700 transition disabled:opacity-60 disabled:cursor-not-allowed"
//             >
//               Add Score
//             </button>
//           </div>
...
//           <div className={`mt-2 rounded-2xl p-4 ${profile.winnings.length > 0
...
//                   : '⚠️ Complete subscription + charity to participate'
//               }
//             </p>
//             {profile.winnings.length > 0 && (
...
//               <p className="mt-1 font-semibold text-slate-900">{profile.drawsEntered || 0}</p>
//             </div>

//             <div className="rounded-2xl bg-slate-50 p-4">
//               <p className="text-sm text-slate-500">Next Draw Date</p>
//               <p className="mt-1 font-semibold text-slate-900">
//                 {formatDate(profile.upcomingDrawDate) || 'TBA'}
//               </p>
//             </div>

//             <div className={`rounded-2xl p-4 ${profile.winnings.length > 0
//                 ? 'bg-emerald-50 border-2 border-emerald-200'
//                 : 'bg-emerald-50/50'
//               }`}>
//               <p className="text-sm text-slate-500">Total Won</p>
//               <p className="mt-1 font-bold text-2xl text-emerald-700">
...
//               <p className={`mt-1 font-semibold ${profile.winnings[0]?.paymentStatus === 'paid'
//                   ? 'text-emerald-700'
...
//               <p className="text-sm font-semibold text-emerald-800">Latest Win Details</p>
...
//                   <p className="font-semibold">{formatDate(profile.winnings[0]?.createdAt)}</p>
//                 </div>
//                 <div>
//                   <span className="text-slate-600">Status:</span>
//                   <span className={`px-2 py-1 rounded-full text-xs font-bold ${profile.winnings[0]?.paymentStatus === 'paid'
